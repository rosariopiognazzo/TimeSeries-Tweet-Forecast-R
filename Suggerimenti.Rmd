...
ggplot(dfClasseInfluenza, aes(x = Classe_Influenza, y = Percentuale, fill = Classe_Influenza)) +
  ...
  theme_minimal()
```
Osserviamo la classe di influenza "bassa" con percentuali nettamente più alte, possiamo concludere che questo tipo di utente è più rappresentato nella piattaforma, mentre alta e moderata si equivalgono.
